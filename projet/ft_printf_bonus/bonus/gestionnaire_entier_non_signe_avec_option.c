...
{
	//printf("\nDébut de gestionnaire_entier_non_signe_avec_option : \n");
	...
	if (option->negative_precision == true)
		...
		gestionnaire_entier_non_signe_avec_largeur_de_champs(option);
		...
		gestionnaire_entier_non_signe_avec_precision(option);
	else
