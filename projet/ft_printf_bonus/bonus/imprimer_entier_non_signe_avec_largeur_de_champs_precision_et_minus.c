...
void	imprimer_entier_non_signe_avec_largeur_de_champs_precision_et_minus(t_format *option) // nom en anglais : 
{
    //printf("\nDébut de imprimer_entier_non_signe_avec_largeur_de_champs_precision_et_minus\n");  
