...
/*
    ...
    if (result_Or != result_Ft) printf("Erreur de correspondance des valeurs de retour pour les combinaisons complexes de flags et de conversions.\n");
    printf("result Or = %d\n", result_Or);
    printf("result Ft = %d\n\n", result_Ft);
    if (result_Or != result_Ft)
        printf("\033[1m\033[31m-----------------------------------------------------Erreur -----------------------------------------------------------------------------------------------------.\n\n\n\n\n\033[0m");
    ...
    if (result_Or != result_Ft) printf("Erreur de correspondance des valeurs de retour pour les flags '+' et ' '.\n");
    printf("result Or = %d\n", result_Or);
    printf("result Ft = %d\n\n", result_Ft);
    if (result_Or != result_Ft)
        printf("\033[1m\033[31m-----------------------------------------------------Erreur -----------------------------------------------------------------------------------------------------.\n\n\n\n\n\033[0m");
...
// Assure-toi de vérifier si ta fonction peut gérer correctement chaque cas.
    ...
    printf("\nTest : 240\n");
    result_Or = printf("Or: Pointeur avec padding de zéros '%020p'\n", (void*)ptr_entier);
    result_Ft = ft_printf("Ft: Pointeur avec padding de zéros '%020p'\n", (void*)ptr_entier);
    printf("result Or = %d\n", result_Or);
    printf("result Ft = %d\n\n", result_Ft);
    if (result_Or != result_Ft)
        printf("\033[1m\033[31m-----------------------------------------------------Erreur -----------------------------------------------------------------------------------------------------.\n\n\n\n\n\033[0m");
   ...
   */ // Test avec un pointeur sur une chaîne de caractères littérale
   ...
   /* result_Or = printf("Or: Pointeur vers chaîne littérale '%p'\n", (void*)ptr_chaine);
    ...
    result_Or = printf("Or: '%-20p*%020p*%p'\n", (void*)ptr_chaine, (void*)&var_const, 10, (void*)&var_volatile);
    result_Ft = ft_printf("Ft: '%-20p*%020p*%p'\n", (void*)ptr_chaine, (void*)&var_const, 10, (void*)&var_volatile);
    printf("result Or = %d\n", result_Or);
    printf("result Ft = %d\n\n", result_Ft);
    if (result_Or != result_Ft)
        printf("\033[1m\033[31m-----------------------------------------------------Erreur -----------------------------------------------------------------------------------------------------.\n\n\n\n\n\033[0m");
